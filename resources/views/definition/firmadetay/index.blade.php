    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                @endif
                <div class="card-header">{{ __('Firma Detay Listesi') }}</div> 
                    <center>
                <div class="col-md-2" ><a href="{{route('firmadetay.create')}}" class="btn btn-xs btn-primary">Yeni</a>
                </div>
            </center>
            <div class="card-body">
