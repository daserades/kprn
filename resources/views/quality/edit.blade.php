                    ...
                    <form method="POST" action="{{ route('quality.update',$quality->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name='firma_id' id="firma_id" class="form-control  @error('firma_id') is-invalid @enderror" required>
                                    <option value="{{$quality->firma_id ?? ''}}">{{$quality->firma->name ?? ''}}</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="sevktrh" type="date" class="form-control @error('sevktrh') is-invalid @enderror" name="sevktrh"  autocomplete="sevktrh" autofocus value="{{$quality->sevktrh ?? ''}}">
                                @error('sevktrh')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="vade" type="text" class="form-control @error('vade') is-invalid @enderror" name="vade"   autocomplete="vade" autofocus value="{{$quality->vade ?? ''}}">
                                @error('vade')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="iskonta" type="text" class="form-control @error('iskonta') is-invalid @enderror" name="iskonta"   autocomplete="iskonta" autofocus value="{{$quality->iskonta ?? ''}}">
                                @error('iskonta')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="bazkur" type="number" step=".001" min="1" class="form-control @error('bazkur') is-invalid @enderror" name="bazkur"  autocomplete="bazkur" autofocus value="{{$quality->bazkur ?? ''}}">
                                @error('bazkur')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="dispatchno" type="text" class="form-control @error('dispatchno') is-invalid @enderror" name="dispatchno"   autocomplete="dispatchno" autofocus value="{{$quality->dispatchno ?? ''}}">
                                @error('dispatchno')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               <textarea id="explanation" type="text" class="form-control"  name="explanation"  autocomplete="explanation" autofocus> {{$quality->explanation ?? ''}}
                               </textarea>
                           </div>
                       </div> 
