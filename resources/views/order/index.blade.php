    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                @endif
                <div class="card-header">{{ __('Sipariş Listesi') }}</div> 
                <div class="row-center">
                <div class="col-md-6" ><a href="{{route('order.create')}}" class="btn btn-xs btn-primary">Yeni</a>
                </div>
            </div>
            <div class="card-body">
...
<script>
  ...
  //var rowData = table.row( this ).data();
        ...
        var table= $('#table').DataTable({
            ...
            { data: 'orderstatus.name' ,"defaultContent": ""},
