...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Sipaiş Oluştur') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('order.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="nakliye1_id" class="col-md-4 col-form-label text-md-right">{{ __('Nakliye Firması') }}</label>

                            <div class="col-md-6">
                                <select name='nakliye1_id' id="nakliye1_id" class="form-control  @error('nakliye1_id') is-invalid @enderror" required>
                                    <option value=""></option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               <textarea id="sevkadres" type="text" class="form-control"  name="sevkadres"  autocomplete="sevkadres" autofocus>
                               </textarea>
                           </div>
                       </div> 
                        <div class="form-group row">
