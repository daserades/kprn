...
}(function ($, moment)
{
	...
	$.dateRangePickerLanguages =
	{
		'default':  //default language: English
		{
			...
			'week-7' : 'pa',
			'week-number': 'W',
			'month-name': ['Ocak','subat','mart','nisan','mayis','haziran','temmuz','agustos','eylul','Ekim','Kasim','Aralik'],
			'shortcuts' : 'Secin : ',
			...
			'default-default': 'Tarihleri secin',
			'time':'Zaman',
			'hour':'Saat',
			'minute':'Dakika'
		}
...
var dateParams = {
			...
			[
				...
				},
				{
					...
					dates : function()
					{
						dateObj.data('dateRangePicker').clear();
						dateObj.data('dateRangePicker').close();
						var objName = dateObj.context.id;
						eval("delete parameters."+objName + 'Start');
						eval("delete parameters."+objName + 'End');
						action();
					}
				}
			]	
